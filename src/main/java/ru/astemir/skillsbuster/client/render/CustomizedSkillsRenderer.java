...
public class CustomizedSkillsRenderer <T extends LivingEntity & ICustomRendered,M extends EntityModel<T>> extends LivingEntityRenderer<T,M> implements ISkillsRenderer<T, IDisplayArgument> {
    private SkillsWrapperEntity<T> entityModelWrapper;

    public CustomizedSkillsRenderer(EntityRendererProvider.Context context, SkillsWrapperEntity entityModel) {
